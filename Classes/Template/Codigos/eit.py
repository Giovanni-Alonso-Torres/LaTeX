...
plt.plot(δp, χ(2*π*6.6).imag, color='dodgerblue', label=r'$\Omega_{c}\neq0$')
plt.plot(δp, χ(0).imag, color='orangered', label=r'$\Omega_{c}=0$')
plt.xticks([0],[0], fontsize=20)
plt.yticks([0],[0], fontsize=20)
plt.xlabel(r'$\delta_{p}$ \textrm{[u.a.]}', fontsize=25)
plt.ylabel(r'$\textrm{Im}{(\chi)}$', fontsize=25)
plt.legend(fontsize=23)
plt.savefig('..\\Imagenes\\eit.pdf', transparent=True, dpi=300)
plt.show()